...
--[[-- SEGFAULT CAN COME FROM THOSE LINES ]]
   local plan = fftw.C['fftwf_plan_many_dft_c2r'](2, dims, batch,in_data_cast, dims, istride,idist,output_data_cast, dims,istride,odist, flags)
   fftw.C['fftwf_execute'](plan)
   fftw.C['fftwf_destroy_plan'](plan)  
--[[--------------------------------------]]
...
function wrapper_fft.my_2D_fft_complex(x,backward,out)   
   local flags = fftw.ESTIMATE
